...
// filtering by subject, and calculates total credits for whatever is
// currently displayed.
...
function renderCourses(filter = "all") {
  ...
  creditTotal.innerHTML = `The total credits for course listed above is <strong>${total}</strong>`;
}
